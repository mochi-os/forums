...
export const ACCESS_LEVELS = [
  {
    value: 'view',
    label: 'View only',
    description: 'Can view posts and comments',
  },
  {
    value: 'vote',
    label: 'Vote',
    description: 'Can vote on posts and comments',
  },
  { value: 'comment', label: 'Comment', description: 'Can comment and vote' },
  {
    value: 'post',
    label: 'Post',
    description: 'Can create posts, comment, and vote',
  },
  {
    value: 'manage',
    label: 'Manage',
  ...
  },
  {
    value: 'none',
    label: 'No access',
    description: 'Blocked from accessing the forum',
  },
] as const
